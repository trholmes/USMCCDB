...
- `seed-coordinates` — fill missing institution details (coordinates, short name, author-list address, ROR id, non-US tagging) from ror.org; `--dry-run`. The Institutions page's "Fill from ROR" does the same from the browser, with interactive review of ambiguous matches.
