...
class Person(TimestampedBase):
    ...
    # Personal funding acknowledgement (issue #127): one or more grant
    # numbers (comma-separated) seed a default text the member can then edit
    # freely; the text is appended to the suggested acknowledgment of
    # publications they are attached to.
    grant_number: Mapped[str | None] = mapped_column(String(500))
